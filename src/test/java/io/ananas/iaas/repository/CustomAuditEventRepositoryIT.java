...
import io.ananas.iaas.config.audit.AuditEventConverter;
import io.ananas.iaas.domain.PersistentAuditEvent;
...
import static io.ananas.iaas.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
